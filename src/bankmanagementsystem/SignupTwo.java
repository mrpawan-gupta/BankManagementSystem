...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    public JComboBox religion, category, income, education, occupation;
    public JButton button;
    public JRadioButton syes, sno, eyes, eno;
    ...
    SignupTwo(String formNo) {
        ...
        additionalDetails.setFont(new Font("Abyssinica SIL", Font.BOLD, 22));
        additionalDetails.setBounds(290, 80, 400, 30);
        add(additionalDetails);

        // Labels
        JLabel religionLabel = new JLabel("Religion:");
        religionLabel.setFont(new Font("Abyssinica SIL", Font.BOLD, 20));
        ...
        cat.setFont(new Font("Abyssinica SIL", Font.BOLD, 20));
        ...
        salary.setFont(new Font("Abyssinica SIL", Font.BOLD, 20));
        ...
        edu.setFont(new Font("Abyssinica SIL", Font.BOLD, 20));
        edu.setBounds(100, 290, 200, 30);
        add(edu);

        JLabel quali = new JLabel("Qualification:");
        quali.setFont(new Font("Abyssinica SIL", Font.BOLD, 20));
        ...
        occu.setFont(new Font("Abyssinica SIL", Font.BOLD, 20));
        ...
        panNo.setFont(new Font("Abyssinica SIL", Font.BOLD, 20));
        panNo.setBounds(100, 440, 200, 30);
        add(panNo);
        // Add Text Field
        pan = new JTextField();
        pan.setFont(new Font("Abyssinica SIL", Font.BOLD, 14));
        pan.setBounds(300, 440, 400, 30);
        add(pan);

        JLabel aadharNo = new JLabel("Aadhar Number:");
        aadharNo.setFont(new Font("Abyssinica SIL", Font.BOLD, 20));
        aadharNo.setBounds(100, 490, 200, 30);
        add(aadharNo);
        // Add Text Field
        aadhar = new JTextField();
        aadhar.setFont(new Font("Abyssinica SIL", Font.BOLD, 14));
        ...
        exAcc.setFont(new Font("Abyssinica SIL", Font.BOLD, 20));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String reli = (String) religion.getSelectedItem(); //find the val of dropdown and convert into string 
